...
public class ObjectId implements Comparable<ObjectId>, java.io.Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equal(ObjectId.serialVersionUID, ObjectId.serialVersionUID) && Objects.equal(ObjectId.LOGGER, ObjectId.LOGGER)
                && Objects.equal(this._time, that._time) && Objects.equal(this._machine, that._machine) && Objects.equal(this._inc, that._inc)
                && Objects.equal(this._new, that._new) && Objects.equal(ObjectId._nextInc, ObjectId._nextInc)
                && Objects.equal(ObjectId._genmachine, ObjectId._genmachine);
    }

    @Override
    public int hashCode() {
        return Objects.hashCode(serialVersionUID, LOGGER, _time, _machine, _inc, _new, _nextInc, _genmachine);
    }
